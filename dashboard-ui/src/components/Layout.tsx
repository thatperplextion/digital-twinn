  ...
  return (
    <div className="min-h-screen bg-mesh relative overflow-hidden">
        ...
        {sidebarOpen && (
          ...
          >
            ...
            <div className="flex h-16 items-center gap-3 px-6 border-b border-white/5">
              ...
              <div>
                <h1 className="text-lg font-bold gradient-text">Digital Twin</h1>
                  ...
                  >
                    <NavLink
                      ...
                      className={clsx(
                        ...
                        isActive
                          ? 'glass-card bg-gradient-to-r from-primary-600/20 to-accent-600/20 text-white shadow-lg shadow-primary-500/10 border-primary-500/30'
                    ...
                    >
                      ...
                      <span className={isActive ? 'gradient-text font-semibold' : ''}>{item.name}</span>
                      {item.name === 'Anomalies' && (
                        <motion.span 
            ...
            <div className="px-4 py-4 border-t border-white/5">
              ...
              >
                ...
                <span className="text-xs text-success-400 font-medium">Live Connection</span>
              </motion.div>
            </div>
          </motion.aside>
        )}
      ...
      <div className={clsx('transition-all duration-500 ease-smooth relative z-10', sidebarOpen ? 'pl-64' : 'pl-0')}>
        {/* Header */}
        <header className="sticky top-0 z-30 h-16 glass-dark border-b border-white/5">
          <div className="flex h-full items-center justify-between px-6">
            <div className="flex items-center gap-4">
              ...
              <div className="relative group">
                <MagnifyingGlassIcon className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-500 group-focus-within:text-primary-400 transition-colors" />
                <input
                  type="text"
            ...
            <div className="flex items-center gap-3">
              ...
              >
                ...
                <span className="text-xs font-bold text-success-400 tracking-wider">LIVE</span>
              </motion.div>
              ...
              <div className="relative">
                ...
                <AnimatePresence>
                  {showNotifications && (
                    ...
                    >
                      <div className="p-4 border-b border-white/5 bg-gradient-to-r from-primary-600/10 to-accent-600/10">
